...
#define MESSAGEID_RESTRICTION_APPLY 		    600
#define MESSAGEID_RESTRICTION_RELEASE 		    601
#define MESSAGEID_RESTRICTION_RELEASE_ALL 	    602
#define MESSAGEID_RESTRICTION_SAFEWORD 		    603
#define MESSAGEID_RESTRICTION_UPDATE	 	    604
#define MESSAGEID_RESTRICTION_REQUEST_STATUS 	606
#define MESSAGEID_RESTRICTION_STATUS 		    607

#define RESTRICTION_BOLTS					0x00000001
#define RESTRICTION_SPEECH				    0x00000002	//Redirects normal chat and emotes to GET_CHANNEL_REDIRECTED_CHAT
#define RESTRICTION_VOLUME_MUTE			0x00000004	//prevents any speech
#define RESTRICTION_MIND					0x00000008
#define RESTRICTION_VOLUME_WHISPER			0x00000010	//only allows whsipers
#define RESTRICTION_VOLUME_NORMAL			0x00000020	//prevents shouting
#define RESTRICTION_VIDEO					0x00000040
#define RESTRICTION_AUDIO					0x00000080
#define RESTRICTION_TELEPORT				0x00000100
#define RESTRICTION_TELEPORT_AV_CONTROL		0x00000200
#define RESTRICTION_MOVEMENT_RUN			0x00000400
#define RESTRICTION_MOVEMENT_WALK			0x00000800	//disables all movement
#define RESTRICTION_MOVEMENT_AV_CONTROL		0x00001000
#define RESTRICTION_FLY					    0x00002000
#define RESTRICTION_TX					    0x00004000	//IM send
#define RESTRICTION_RX					    0x00008000	//IM receive
#define RESTRICTION_GEOLOCATION			    0x00010000
#define RESTRICTION_FACIAL_RECOGNITION		0x00020000
#define RESTRICTION_RADAR					0x00040000
#define RESTRICTION_NOTECARD				0x00080000
#define RESTRICTION_START_TX				0x00100000

#define MESSAGEID_SET_STANDARD_DRAIN 		900
#define MESSAGEID_CHARGE 				901
#define MESSAGEID_GET_BATTERY_STATUS 		902
#define MESSAGEID_BATTERY_STATUS			903

#define MESSAGEID_FILTER_REGISTER           700
#define MESSAGEID_FILTER_UNREGISTER         701
#define MESSAGEID_FILTER_NEXT_FILTER 		702
#define MESSAGEID_FILTER_OUTPUT 			703
#define MESSAGEID_FILTER_INPUT				704
#define MESSAGEID_REQUEST_FILTERS			707
